...
export default function BusinessPaymentDetail() {
    const requestDetail = useSelector((state) => state.requestDetail.requestDetailvalue);

    // Safe access to payment registration data
    const paymentData = requestDetail?.businessPaymentRegistration;
    ...
    return (
        <>
            ...
            <DetailItem label="Số tiền" value={formatCurrency(paymentData.amount, paymentData.currency)} />
