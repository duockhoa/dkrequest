...
export default function BusinessAdvanceClearanceDetail() {
    const requestDetail = useSelector((state) => state.requestDetail.requestDetailvalue);
    const businessAdvanceClearanceRequest = requestDetail?.businessAdvanceClearanceRequest;
    ...
    const {
        ...
        spendings = [],
        unspent_amount = null,
    } = businessAdvanceClearanceRequest || {};
    ...
    if (!businessAdvanceClearanceRequest) {
        return (
