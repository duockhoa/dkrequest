...
export default function BusinessAdvanceClearanceSpendingsForm() {
    ...
    const spendingsForServer = (requestFormData?.business_advance_clearance_request?.spendings || []).map((s) => ({
