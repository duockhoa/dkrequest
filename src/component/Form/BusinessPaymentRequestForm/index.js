...
function BusinessPaymentRequestForm() {
    ...
    const handleChange = (e) => {
        ...
        const previousCurrency = requestFormData?.business_payment_request?.currency || 'VND';

        // Lấy dữ liệu mới nhất sau khi thay đổi
        let newPaymentRequest = {
            ...requestFormData.business_payment_request,
            [name]: processedValue,
        };
        ...
        if (name === 'currency' && newPaymentRequest.amountText) {
            const numericValue =
                ...
                parseCurrencyAmountInput(newPaymentRequest.amountText, previousCurrency);
        ...
        dispatch(
            setRequestFormData({
                ...requestFormData,
                business_payment_request: newPaymentRequest,
                requestName,
            }),
        );
    };
        ...
        <Stack spacing={3}>
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <Select
                    fullWidth
                    name="payment_type"
                    value={requestFormData?.business_payment_request?.payment_type || ''}
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    ...
                    value={requestFormData?.business_payment_request?.payment_content || ''}
                    onChange={handleChange}
                    multiline
                    size="medium"
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="pay_to"
                    value={requestFormData?.business_payment_request?.pay_to || ''}
                    onChange={handleChange}
                    size="medium"
                    inputProps={{ style: { fontSize: '1.4rem' } }}
                    error={!!errors?.pay_to}
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="amountText"
                    value={requestFormData?.business_payment_request?.amountText || ''}
                    onChange={handleChange}
                    size="medium"
                    inputProps={{
                    ...
                    InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
                                <Select
                                    name="currency"
                                    value={requestFormData?.business_payment_request?.currency || 'VND'}
                                    onChange={handleChange}
                                    size="small"
                                    variant="standard"
                                    sx={{
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="due_date"
                    value={requestFormData?.business_payment_request?.due_date || ''}
                    onChange={handleChange}
                    size="medium"
                    type="date"
            ...
            {(requestFormData?.business_payment_request?.currency || 'VND') === 'VND' && (
                <>
                    <Stack direction="row" alignItems="center" spacing={2}>
                        ...
                        <Autocomplete
                            ...
                            value={
                                bankOptions.find(
                                    (b) => b.label === requestFormData?.business_payment_request?.bank_name,
                                ) || null
                            }
                            onChange={(_, newValue) => {
                                dispatch(clearErrors());
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        ...
                        <TextField
                            ...
                            value={requestFormData?.business_payment_request?.bank_account_number || ''}
                            onChange={handleChange}
                            size="medium"
                            type="text"
                            inputProps={{
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        ...
                        <TextField
                            ...
                            value={requestFormData?.business_payment_request?.beneficiary_name || ''}
                            onChange={handleChange}
                            size="medium"
                            inputProps={{
                                style: { fontSize: '1.4rem' },
            ...
            {requestFormData?.business_payment_request?.payment_type === 'invoice' && (
                <FileUpload fieldName="invoices" label="Hóa đơn" multiple={true} maxSize={100} />
            )}
            {requestFormData?.business_payment_request?.payment_type === 'no_invoice' && (
...
export default BusinessPaymentRequestForm;
