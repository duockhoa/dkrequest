...
function BusinessAdvanceMoneyRequestForm() {
    ...
    useEffect(() => {
        if (userInfo) {
            const currentAdvanceRequest = requestFormData?.business_advance_money_request || {};
            console.log(userInfo.department);
            dispatch(
                setRequestFormData({
                    ...requestFormData,
                    business_advance_money_request: {
    ...
    useLayoutEffect(() => {
        if (
            userInfo &&
            (!requestFormData?.business_advance_money_request?.address ||
                !requestFormData?.business_advance_money_request?.beneficiary_name)
        ) {
            dispatch(
                setRequestFormData({
                    ...requestFormData,
                    business_advance_money_request: {
                        ...requestFormData?.business_advance_money_request,
                        address: requestFormData?.business_advance_money_request?.address || userInfo.department || '',
                        beneficiary_name:
                            requestFormData?.business_advance_money_request?.beneficiary_name ||
    ...
    const amountInWords = () => {
        const amount = requestFormData?.business_advance_money_request?.amount;
        ...
        <Stack spacing={3}>
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <Select
                    fullWidth
                    name="reason"
                    value={requestFormData?.business_advance_money_request?.reason || ''}
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="address"
                    value={requestFormData?.business_advance_money_request?.address || ''}
                    onChange={handleChange}
                    size="medium"
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="amountText"
                    value={requestFormData?.business_advance_money_request?.amountText || ''}
                    onChange={handleChange}
                    size="medium"
                    inputProps={{
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    fullWidth
                    name="due_date"
                    value={requestFormData?.business_advance_money_request?.due_date || ''}
                    onChange={handleChange}
                    size="medium"
                    type="date"
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <Autocomplete
                    ...
                    value={
                        bankOptions.find(
                            (b) => b.label === requestFormData?.business_advance_money_request?.bank_name,
                        ) || null
                    }
                    onChange={(_, newValue) => {
                        dispatch(clearErrors());
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    ...
                    value={requestFormData?.business_advance_money_request?.bank_account_number || ''}
                    onChange={handleChange}
                    size="medium"
                    inputProps={{
                        style: { fontSize: '1.4rem' },
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
                ...
                <TextField
                    ...
                    value={requestFormData?.business_advance_money_request?.beneficiary_name || ''}
                    onChange={handleChange}
                    disabled={true}
                    size="medium"
                    inputProps={{
...
export default BusinessAdvanceMoneyRequestForm;
